...
.reset_account_container input[type=text] {
	position: absolute;
	width: 300px;
	height: 34px;
	left: 775px;
...
%>
	...
	<p class="user_detail">&nbsp;User Detail</p>	
		...
		<form action="AdminUnlock" method="post">
		<input type="text" name="admin_unlock_email" placeholder="Enter your email address">
		<p class="unlock"><input type="submit" name="unlock_account" value="Unlock Account"></p>
		<p class="unlock_account_result"><label for="unlock_account_result">Result &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <%=request.getAttribute("adminUnlockResult")%></label></p>
		</form>
		</div>
		...
		<input type="text" name="admin_reset_email" placeholder="Enter your email address">
		<p class="reset"><input type="submit" name="reset_account" value="Reset Account Password"></p>
		<p class="reset_account_result"><label for="reset_account_result">Result &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <%=request.getAttribute("adminResetResult")%></label></p>
		</form>
		</div>
	</div>

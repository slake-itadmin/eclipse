...
<title>Active Directory User Details</title>
<style>
.outer {
	display: table;
	position: absolute;
...
<script type = "text/javascript">
   function RequestReset() {
      alert ("You have request to reset your domain id's password.\nPlease click the link below to change your domain id's password.");
   }
</script>
			...
			<div class="user_detail">
				...
				<div class="user_detail_list">
					<table>
						...
						<tr>
							<td width="4%"></td>
    						<td width="44%" class="caption">Full Name</td>
							<td width="3%"></td>
							<td width="44%" class="caption">
						...
						<tr>
							...
							<td width="15"></td>
							<td style="height:60px" width="205" class="tablebutton">
								<form action="UserRequestReset" method="post" onclick="RequestReset();">
...
<%-- Get user email from UserCheck --%>
<% String user_email = (String)request.getAttribute("found_email"); %>
        
<%-- Pass user's detail to UserRequestReset.java --%>
<%    
	session.setAttribute("full_name", String.valueOf(userDetails.get(0)));
	session.setAttribute("domain_name", String.valueOf(userDetails.get(1)));
	session.setAttribute("domain_id", String.valueOf(userDetails.get(2)));
	session.setAttribute("user_email", String.valueOf(user_email));
%>	
</body>
</html>